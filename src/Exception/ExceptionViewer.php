...
class ExceptionViewer
{
     ...
     * @return int
     */
    public function getHttpStatusCode($exception): int
    {
     ...
     * @return string
     */
    public function getHumanExceptionTitle($e): string
    {
        ...
        if ($e instanceof ConnectionException || $e instanceof \Doctrine\DBAL\ConnectionException) {
     ...
     * @return string
     */
    public function getJsonError($e): string
    {
        if ($e instanceof NoConfigurationFoundException) {
     ...
     */
    public function getResponse($e, Request $request, bool $debug = false): Response
    {
        /*
