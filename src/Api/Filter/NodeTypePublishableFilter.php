...
final class NodeTypePublishableFilter extends AbstractFilter
{
    ...
    protected function filterProperty(
        ...
        $publishable = in_array($value, self::TRUE_VALUES);
    ...
    public function getDescription(string $property): array
    {
        return [
            self::FILTER => [
                ...
                'description' => 'Filter items when their node-type is publishable or not.',
                'type' => 'boolean',
                'required' => false,
            ],
            self::FILTER_COMPAT => [
                'property' => self::FILTER_COMPAT,
                'description' => sprintf('Filter items when their node-type is publishable or not. **Deprecated: Use *%s* instead.**', self::FILTER),
